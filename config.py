...
desc += '-mnist';            dataset = EasyDict(tfrecord_dir='dataset', resolution=128); train.mirror_augment = False
...
desc += '-preset-v2-1gpu'; num_gpus = 1; sched.minibatch_base = 4; sched.minibatch_dict = {128: 2}; sched.G_lrate_dict = {1024: 0.0015}; sched.D_lrate_dict = EasyDict(sched.G_lrate_dict); train.total_kimg = 150
...
desc += '-VERBOSE'; sched.tick_kimg_base = 0.1; sched.tick_kimg_dict = {}; train.image_snapshot_ticks = 1; train.network_snapshot_ticks = 100
